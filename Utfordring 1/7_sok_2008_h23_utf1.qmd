...
plot <- eurostat %>% 
  ...
  geom_point()+
  labs(x="HF3: Household out-of-pocket payment", y="HF1: Government schemes and compulsory contributory health care financing schemes", caption = "Eurostat hlth_sha11_hf", title="PC_CHE: Percentual share of total current health expenditure (CHE)")+
