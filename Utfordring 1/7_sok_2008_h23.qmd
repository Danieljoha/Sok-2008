...
plot <- eurostat %>% 
  ...
  geom_point()+
  labs(x="Household out-of-pocket payment", y="Purchasing power standard (PPS) per inhabitant", caption = "Eurostat hlth_sha11_hf", title="Egenandeler som andel av totale utgifter helsetjenester")+
...
Det vi ser er at når egenandelen øker, så synker utgiftene til helsetjenester. Den økte egenbetalingen reduserer bruk av helsetjenester, slik at du kan få et underforbruk av helsetjenester slik at problemer blir større over tid. \clearpage \### 1.2.2
