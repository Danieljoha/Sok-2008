...
plot <- df_07459 %>%
  ...
  labs(x="", y="", fill="", alpha="", title="Norges populasjon", caption="SSB tabell 07459", subtitle="2003, helfargede søyler. 2023, gjennomsiktige")+
...
plot <- eurostat %>% 
  ...
  geom_point()+
  labs(x="Egenandel andel av totale helsekostnader", y="Kjøpekrafts justerte totale kostnader per innbygger", caption = "Eurostat hlth_sha11_hf", title="Egenandeler som andel av totale utgifter helsetjenester")+
...
ax.text(20, 22, '$m$ er arbeidsfri inntekt', fontsize=12)
...
ax.text(-2, indiff_x_2(nytte_kvinne,.4,.4,x)[10], '$w_2$', fontsize=12)
